const dummyData = {
    ...
    customizations: [
        // toppingss
        { name: "Extra Cheese", price: 25, type: "toppings" },
        { name: "Jalapeños", price: 20, type: "toppings" },
        { name: "Onions", price: 10, type: "toppings" },
        { name: "Olives", price: 15, type: "toppings" },
        { name: "Mushrooms", price: 18, type: "toppings" },
        { name: "Tomatoes", price: 10, type: "toppings" },
        { name: "Bacon", price: 30, type: "toppings" },
        { name: "Avocado", price: 35, type: "toppings" },
